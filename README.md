...
This project implements a breakout strategy. As part of the project, we find and remove any outliers, and test to see if it has the potential to be profitable using a Histogram and P-Value.
...
Create a new `ai-trading-breakout-strategy` Conda environment installing the required packages:

```bash
conda create --file ai-trading-breakout-strategy.yml
```

Activate the environment:

```bash
conda activate ai-trading-breakout-strategy
```
...
Open the `breakout-strategy.ipynb` notebook and follow the instructions.
